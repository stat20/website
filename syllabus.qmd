...
Class time (2 hrs) will be spent on a range of activities, but the most common will be concept questions (using Poll Everywhere) and working through handouts relating to your assignments (Labs and Problem Sets). Therefore, the most efficient way to complete your labs will to be an active participant in class! Attendance is expected on Wednesday and Friday.
...
If you would like to communicate with us regarding a personal matter, you can do that in Ed by flagging your post as private. 
...
We will be giving completion grade credit to some of the problems and assessing some questions for correctness.
...
During class, we will give you a second engagement with the day's material in the form a worksheet. These worksheets will run like traditional homework problems and drill the concepts in the reading notes rather than asking you to apply the concepts with a data set, like the lab does.

The problem sets will be procured completely from these in-class worksheets and released in one or two week intervals at the end of the week. You will be given one problem set drop during the semester, meaning that the lowest problem set score you attain will be dropped. 
...
Quizzes will be held biweekly in-class on Fridays.
...
The *individual* component will last 25 minutes. You are allowed one, A4, two-sided sheet of notes. The *group* component will take place immediately after the individual component has been completed and will last 15 minutes. 
...
Each plenary lecture will be announced once it has been confirmed. We will send out an RSVP form for you to indicate whether you expect to attend or not. Please fill this out so that we have a good measure of the amount of students we can expect.

We wil hold *five plenary lectures* throughout the semester! Each lecture will have a corresponding assignment that can be completed afterward. Of these five lectures, you may attend and complete the assignment for two of them to receive full credit for this part of the course. 
