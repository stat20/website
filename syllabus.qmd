...
From Lab 2 forward, we will exact a *10 percent penalty* on any labs which fail to meet these formatting requirements. This penalty will apply *on top* of the standard late penalty which will be described below in the **Late Work** section of this syllabus.

#### Problem Sets

The problem set is meant as practice: practice with the concepts and methods from the lecture notes that you'll need to hone in order to do the labs well and succeed on the quizzes. The problems will be selected from handouts that we will work on in class, so if you work on the in-class handouts, you will in essence be completing part of your problem set.
...
To make sure that the problem sets also serve as study material, we will be providing video solutions to them. The videos will be recorded by the instructional staff and will be released Tuesday morning at 8am (the morning after the deadline).

##### Submission Format

Since the problem sets are completion grade, we do not require any submission format other than one which can be easily graded. 
