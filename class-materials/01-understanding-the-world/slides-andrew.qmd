...
- In groups of 3, take turns introducing yourselves to one another by providing the info listed on the handout.
...
- Each person should finish with a handout filled-in with info on their groupmates.
  ...
  - \# Siblings + \# Pets
  - \# Semesters at Cal
  - Farthest distance from Cal this summer
...
- Enter them at `pollev.com/andrew` or upvote existing explanations if they are very similar to your own.
:::
:::
...
:::{.poll}
Does this image change which claims are more or less likely? Up and down vote explanations at `pollev.com/andrew`.
:::
...
:::poll
What type of *data* can help answer this question?
...
Enter your group's answer at `pollev.com/stat20`. *Be precise*.
:::
...
<center>
<iframe src="https://embed.polleverywhere.com/free_text_polls/CW1Rk0bjcNGSMs17dFAj6?controls=none&short_poll=true" width="1300" height="800px"></iframe>
</center>
...
<center>
<iframe src="https://embed.polleverywhere.com/discourses/1gFyj0PK3VA2QHNYf1GPn?controls=none&short_poll=true" width="1300" height="800"></iframe>
</center>
...
::: {.column width="50%"}
- Read the lecture notes for "Taxonomy of Data" (to be posted this afternoon)
- Leave a comment or ask a question on Perusall
- Answer the reading questions on Gradescope by 11 pm Thursday
- Complete Problem Set 1 by Monday 11 pm
:::
...
![](https://media.giphy.com/media/XVuBomL9gXMTC/giphy.gif){fig-alt="Animated gif of a shoebill bird." width=800}
:::
