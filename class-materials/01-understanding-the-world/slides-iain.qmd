...
##  {data-menu-title="Claims 8" background-image="images/stat20-sketch-05.jpg" background-size="contain" transition="none"}


As a group write down definitions for each kind of analysis
...
## Perusall General discussion

::: columns
::: {.column width="50%"}
![](images/perusall-general-discussion.png)
:::

::: {.column .fragment width="50%"}
Post your group's data analysis definitions on **General discussion**
:::
:::
