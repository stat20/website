...
::: {.column width="35%"}
:::{.poll style="font-size: .8em"}
- As a group, formulate at least **three** possible explanations for what's going on in the picture.  
- Enter them at `pollev.com/shobhana` or upvote existing explanations if they are very similar to your own.
:::
:::
...
<!-- <iframe src="https://embed.polleverywhere.com/discourses/zB8Ez5K5LX1Hh5CriSFWj?controls=none&short_poll=true" width="800px" height="600px"></iframe> -->


<!-- <iframe src="https://embed.polleverywhere.com/discourses/AYUPwcUZMOXrasZDClOza?controls=none&short_poll=true" width="1300" height="800px"></iframe> -->
<!-- </center> -->
...
:::{.poll}
Does this image change which claims are more or less likely? Up and down vote explanations at `pollev.com/shobhana`.
:::
...
:::poll
Will this question be answered by a summary, a prediction, a generalization, or a causal claim? What type of *data* can help answer this question? (Go to `pollev.com/shobhana` to put your answers in, or up/down vote answers.)
:::
...
:::{.poll}
Formulate one claim that is supported by this data[^1].(At `pollev.com/shobhana`.)
:::
...
::: {.column width="50%"}
- Read the lecture notes for "Taxonomy of Data", which will be posted by tonight.
